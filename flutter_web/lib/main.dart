...
class _MineBotHomePageState extends State<MineBotHomePage> {
  ...
  String formatServerTime(double? value) {
    ...
    final millis = value > 10_000_000_000 ? value.toInt() : (value * 1000).toInt();
  ...
  Widget _tutorialView() {
    return Padding(
      ...
      child: Column(
        ...
        children: [
          const Text('Welcome to MineBot', style: TextStyle(fontSize: 30, fontWeight: FontWeight.bold)),
          const SizedBox(height: 12),
          const Text('Manage your bot, servers, accounts, and live status from the web client.'),
